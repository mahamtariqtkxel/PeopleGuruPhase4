...
(/** @lends <global> */function( $ ) {
	...
	function _fnDraw( oSettings )
	{
		...
		if ( aiDisplay.length !== 0 )
		{
			...
			for ( var j=iStart ; j<iEnd ; j++ )
			{
                ...
                //Custom IS 10/22/2015 allows hidding rows with paging, useful when doing a search
				if (!aoData)
				    return false;
				...
				if (!($(nRow).hasClass("hidden-data-row"))) {  //Custom IS 10/22/2015 allows hidding rows with paging, useful when doing a search
				...
				else {  //Custom IS 10/22/2015 allows hidding rows with paging, useful when doing a search
				    iEnd = iEnd + 1;
				}
	...
	{
        //Modified 07/10/2014 Suppress warnings
